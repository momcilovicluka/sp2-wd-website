...
function proveriIme() {
  return document.getElementsByName("ime")[0].value.length >= 2 && document.getElementsByName("ime")[0].value.length <= 15;
}
...
function proveriPrezime() {
  return document.getElementsByName("prezime")[0].value.length >= 3 && document.getElementsByName("prezime")[0].value.length <= 20;
}
